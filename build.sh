...
#
STACK_IMAGE="${STACK_IMAGE:-emezari/application-stack-ol200011-java14:0.0.1}"

#
# URL at which your outer loop Dockerfile is hosted
#
DEVFILE_DOCKERFILE_LOC="${DEVFILE_DOCKERFILE_LOC:-https://github.com/mezarin/application-stack/releases/download/custom-ol200011-java14/Dockerfile}"
